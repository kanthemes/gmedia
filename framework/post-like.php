...
function sl_enqueue_scripts() {
	wp_enqueue_script( 'simple-likes-public-js', get_template_directory_uri() . '/dist/js/simple-likes-public.js', array( 'jquery' ), '0.5', false );
...
function show_user_likes( $user ) { ?>        
	<table class="form-table">
		<tr>
			<th><label for="user_likes"><?php _e( 'You Like:', 'gm' ); ?></label></th>
			<td>
			<?php
			...
			<?php else : ?>
			<p><?php _e( 'You do not like anything yet.', 'gm' ); ?></p>
			<?php 
			endif; 
			wp_reset_postdata(); 
			?>
