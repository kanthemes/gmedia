...
function gmedia_navbar() {
	echo '<a rel="nofollow" href="https://www.kanthemes.com" title="Kan Themes - Kaliteli ve SEO Uyumlu Türkçe Wordpress Temaları">Wordpress Temaları</a>';
}
...
<p>Gmedia, <a href="https://www.kanthemes.com" title="Kan Tema - Ücretli Türkçe Wordpress Temaları">Wordpress Temaları</a> aracılığıyla ücretsiz paylaşılmış bir wordpress blog temasıdır. Emeğimize teşekkür etmek için sitemizi ziyaret edip yorum bırakabilirsiniz.</p>
<p>
<a class="button-secondary" target="_blank" href="https://www.kanthemes.com/urun/gmedia-ucretsiz-blog-temasi/"> <?php printf(esc_html__('Teşekkür Et', 'geoit')); ?></a>	<a class="button-primary" href="https://www.kanthemes.com/shop/" target="_blank">					<?php esc_html_e('Diğer Temalarımıza Göz At', 'geoit'); ?></a>
</p>
</div>
<?php }
